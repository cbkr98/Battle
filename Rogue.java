public class Rogue extends Character {
	...
	Rogue() {
		this.healthCap = (int)((Math.random()*4)+10);
		this.attackCap = (int)((Math.random()*3)+1);
		this.armorCap = (int)((Math.random()*2)+0);
		this.speedCap = (int)((Math.random()*4)+2);
		this.intelligenceCap = (int)((Math.random()*2)+1);
		this.willCap = (int)((Math.random()*2)+1);
		this.mpCap = (int)((Math.random()*3)+2);
		this.staminaCap = (int)((Math.random()*4)+6);
