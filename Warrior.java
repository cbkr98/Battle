public class Warrior extends Character{
	...
	Warrior() {
		this.healthCap = (int)((Math.random()*3)+12);
		this.attackCap = (int)((Math.random()*3)+2);
		this.armorCap = (int)((Math.random()*2)+1);
		this.speedCap = (int)((Math.random()*2)+1);
		this.intelligenceCap = (int)((Math.random()*2)+1);
		this.willCap = (int)((Math.random()*2)+0);
		this.mpCap = (int)((Math.random()*3)+2);
		this.staminaCap = (int)((Math.random()*3)+8);
